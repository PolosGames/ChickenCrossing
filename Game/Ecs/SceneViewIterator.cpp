...
SceneViewIterator::SceneViewIterator(base_scene_view const* view, EntityIndex index) 
    : m_Index{index}, m_View{view}
{

}

Entity& SceneViewIterator::operator*() const
{
...
bool SceneViewIterator::CheckValid()
{
    ...
    return IsEntityValid(entities[m_Index].id) &&
